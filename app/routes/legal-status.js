  ...
  },
  {
    ...
    options: {
      ...
      handler: (request, h) => {
        ...
        return (request.payload.legalStatus === 'Other') ? h.view('not-eligible', createModelNotEligible()) : h.redirect('/slurry/country')
      }
    }
  }
]
