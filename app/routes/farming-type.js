  ...
  },
  {
    ...
    options: {
      ...
      handler: (request, h) => {
        ...
        return request.payload.farmingType !== 'Something else' ? h.redirect('/slurry/legal-status') : h.view('not-eligible', createModelNotEligible())
      }
    }
  }
]
