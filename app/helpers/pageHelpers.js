...
const getCheckDetailsModel = (request, question, backUrl, nextUrl) => {
  ...
  const agentContact = saveValuesToArray(agentDetails, ['emailAddress', 'mobile', 'landlineNumber'])
  const agentAddress = saveValuesToArray(agentDetails, ['address1', 'address2', 'town', 'county', 'postcode'])

  const farmerContact = saveValuesToArray(farmerDetails, ['emailAddress', 'mobile', 'landlineNumber'])
