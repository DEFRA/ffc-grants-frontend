const errors = {
  ...
  'error.projectPostcode.string.pattern.base': 'Enter a project postcode, like AA1 1AA',
  'error.projectPostcode.string.empty': 'Enter a project postcode, like AA1 1AA',
  'error.projectPostcode.any.required': 'Enter a project postcode, like AA1 1AA',
  'error.businessPostcode.any.required': 'Enter a business postcode, like AA1 1AA',
  'error.businessPostcode.string.pattern.base': 'Enter a business postcode, like AA1 1AA',
  'error.businessPostcode.string.empty': 'Enter a business postcode, like AA1 1AA',
  ...
  'error.emailConfirm.any.required': 'Enter an email address that matches',
  ...
  'error.landline.string.empty': 'Enter a landline number (If you do not have a landline, enter your mobile number)',
  'error.landline.string.min': 'Your landline number must have at least 10 characters',
  'error.landline.any.required': 'Enter a landline number (If you do not have a landline, enter your mobile number)',
