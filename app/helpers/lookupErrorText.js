const errors = {
  ...
  'error.waterSourceCurrent.any.required': 'Select one or two options to describe current irrigation water comes from',
  'error.waterSourcePlanned.any.required': 'Select one or two options to describe your irrigation water will come from',
