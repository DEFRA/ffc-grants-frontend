const errors = {
  ...
  'error.waterSourceCurrent.any.required': 'Select up to 2 options where your current irrigation water comes from',
  'error.waterSourcePlanned.any.required': 'Select up to 2 options where your irrigation water will come from',
