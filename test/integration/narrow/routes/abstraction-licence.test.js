...
describe('Abstraction licence page', () => {
  ...
  it('if value = \'Should be in place by 31 October 2024\' ==> store and redirect to abstraction-required-condition page', async () => {
    const postOptions = {
      method: 'POST',
      url: `${global.__URLPREFIX__}/abstraction-licence`,
      payload: { abstractionLicence: 'Should be in place by 31 October 2024', crumb: crumbToken },
      headers: { cookie: 'crumb=' + crumbToken }
    }
  ...
  it('if value = \'Will not be in place by 31 October 2024\' ==> store and redirect to abstraction-required-condition page', async () => {
    const postOptions = {
      method: 'POST',
      url: `${global.__URLPREFIX__}/abstraction-licence`,
      payload: { abstractionLicence: 'Will not be in place by 31 October 2024', crumb: crumbToken },
      headers: { cookie: 'crumb=' + crumbToken }
    }
