 Feature: Farming Type

    Scenario: Choosing Horticulture farming type
    ...
    Scenario: Choosing Crop farming type
    ...
    Scenario: Choosing Something else
        ...
        And I pause for 500ms
        Then I expect that element "h1" contains the text "What crops are you growing?"
