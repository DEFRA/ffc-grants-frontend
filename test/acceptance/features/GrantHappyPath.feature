Feature: Grant 
    ...
    #    Examples:
    #    |cropType      |trades        |permission         |preparatoryWork |projectItems       |licence   |projectSummary            |cropsIrrigated    |hectare_1|hectare_2|waterSource_Current  |waterSource_Target   |irrigationSystem_Current   |irrigationSystem_Target|productivity                        |overllscore|productImpact|currentLandIrrig|currentWaterSource|currentIrrigSystems|productivityScore|waterSharing|
      #  |#farmingType  |trust         |notNeededPermission|yesPrepWork     |engrFees           |secured   |improveAndIntroIrrigation |croppingIrrigation|  101    | 200     |RainWater&MainsWaterC|Peakflow&SummerWaterP|currentTrickleAndRain      |plannedMistAndBoom     |maintainProductivity&high-valueCrops|Average    |Average      |Strong          |Average           |Average            |Average          | Strong     |
    #    |#farmingType  |sole          |notNeededPermission|yesPrepWork     |construction       |notNeeded |changeWater&IncreaseIrrig |cropIrrigation    |  100    | 101     |PeakFlow&MainsWaterC |RainWater&BoreHoleP  |currentMist&Rain           |plannedEbbAndCapillary |increasedYield&improvedQuality      | Average   | Strong      | Strong         | Average          | Average           | Average         | Strong     |
      # |#farmingType-2|partnership   |secured            |noWorkDoneYet   |overFlow            |secured   |changeWater&ImproveIrrig  |croppingIrrigation|  50     | 50      |PeakFlow&RainWaterC  |SummerWater&BoreHoleP|currentTrickle&Mist        |plannedMistAndEbb      |high-valueCrops&ImprovedQuality     | Weak      | Strong      | Strong         | Weak             | Average           | Average         | Strong     |
     #   |#farmingType-2|charity       |secured            |noWorkDoneYet   |abstractonPump     |notNeeded |improve&IntroIrrigation   |cropIrrigation    |  40     | 41      |PeakFlow&RainWaterC  |BoreHole&MainP       |currentMist&Ebb            |plannedEbbAndSprinklers|high-valueCrops&protectedCrops      | Weak      | Average     | Strong         | Weak             | Average           | Strong          | Weak       |     
    #   |#farmingType  |limitedCompany|notNeededPermission|yesPrepWork     |syntheticliner      |secured   |intro&increaseIrrigation  |fruitIrrigation   |  30     | 70      |PeakFlow&RainWaterC  |SummerWater&MainP    |currentEbbAndSprinklers    |plannedSprinklers&Capi |maintainProductivity&high-valueCrops| Weak      | Weak        | Strong         | Weak             | Average           | Average         | Strong     |
    #   |#farmingType-2|liaPartnership|secured            |noWorkDoneYet   |synLinedReservoir   |secured   |improve&IncreaseIrrigation|fruitIrrigation   |  30     | 40      |RainWater&BoreHoleC  |SummerWater&BoreHoleP|currentSprinklers&Capillary|plannedBoom&Capillary  |improvedQuality&maintainProductivity| Weak      | Average     | Strong         | Weak             | Average           | Weak            | Weak       |
    #   |#farmingType  |communityInt  |notNeededPermission|yesPrepWork     |filtrationEquip     |notNeeded |increaseIrrigation        |cropIrrigation    |  45     | 67      |PeakFlow&RainWaterC  |Peakflow&MainP       |currentBoom&Capillary      |plannedBoom&Rain       |improvedQuality                     | Weak      | Weak        | Strong         | Weak             | Weak              | Weak            | Strong     |    
     #  |#farmingType-2|ltdPartnership|secured            |noWorkDoneYet   |irrigationPump      |notNeeded |improveIrrigation         |croppingIrrigation|  22     | 44      |PeakFlow&RainWaterC  |Peakflow&RainWaterP  |currentBoom&Rain           |plannedRain&Trickle    |protectedCrops                      | Strong    | Weak        | Strong         | Strong           | Average           | Average         | Weak       |    
     #  |#farmingType  |industrialSty |notNeededPermission|yesPrepWork     |pipeWork            |secured   |changeWater               |fruitIrrigation   |  10     | 500     |currentPeakFlow      |plannedRainWater     |currentBoom                |plannedTrickle         |high-valueCrops                     |
     #  |#farmingType-2|coopSociety   |secured            |noWorkDoneYet   |pumpHouse           |notNeeded |increaseIrrigation        |cropIrrigation    |  20     | 21      |SummerWater&Main     |Peakflow&BoreHole    |currentBoom&Capillary      |plannedTrickle&Mist    |increasedYield&improvedQuality      |
     #  |#farmingType  |BenCom        |notNeededPermission|yesPrepWork     |undergroundWater    |notNeeded |increaseIrrigation        |croppingIrrigation|  50     | 51      |currentPeakFlow      |plannedPeakFlow      |currentBoom                |plannedRain            |high-valueCrops                     |                    
     #  |#farmingType-2|sole          |secured            |noWorkDoneYet   |electInstallation   |secured   |increaseIrrigation        |fruitIrrigation   |  10     | 10      |currentMainsWater    |plannedPeakFlow      |currentRain                |plannedBoom            |high-valueCrops                     |
     #  |#farmingType  |partnership   |notNeededPermission|yesPrepWork     |boom                |notNeeded |introduceIrrigation       |cropIrrigation    |  20     | 20      |currentMainsWater    |plannedPeakFlow      |currentRain                |plannedRain            |protectedCrops                      |
     #  |#farmingType-2|limitedCompany|secured            |noWorkDoneYet   |trickle             |secured   |changeWater               |croppingIrrigation|  5      |  5      |currentMainsWater    |plannedRainWater     |currentEbb                 |plannedEbb             |maintainProductivity                |
     #  |#farmingType  |charity       |notNeededPermission|yesPrepWork     |ebbAndFlow          |notNeeded |changeWater               |fruitIrrigation   |  15     | 15      |currentSummerWater   |plannedPeakFlow      |currentRain                |plannedRain            |maintainProductivity                |
     #  |#farmingType-2|trust         |secured            |noWorkDoneYet   |capillaryBed        |secured   |changeWater               |cropIrrigation    |  5      |  5      |currentSummerWater   |plannedPeakFlow      |currentRain                |plannedRain            |maintainProductivity                |
     #  |#farmingType  |liaPartnership|notNeededPermission|yesPrepWork     |sprinklers          |notNeeded |changeWater               |croppingIrrigation|  15     | 15      |currentBoreHole      |plannedPeakFlow      |currentTrickle             |plannedTrickle         |maintainProductivity                |
     #  |#farmingType-2|communityInt  |secured            |noWorkDoneYet   |mist                |secured   |changeWater               |fruitIrrigation   |  20     | 20      |currentSummerWater   |Peakflow&SummerWaterP|currentBoom                |plannedBoom            |maintainProductivity                |
